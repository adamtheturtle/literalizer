...
class Nix(metaclass=LanguageCls):
    ...
    format_string = staticmethod(_format_nix_string)
    format_integer = staticmethod(str)
    format_sequence_entry = staticmethod(_format_nix_sequence_entry)
    format_set_entry = staticmethod(_format_nix_sequence_entry)
