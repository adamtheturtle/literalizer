...
class Haskell(metaclass=LanguageCls):
    ...
    dot_access_style: DotAccessStyles = DotAccessStyles.OVERLOADED_RECORD_DOT
    indent: str = "    "
    type_name: str = "Val"
    ...
    def format_call_preamble_stub(
        ...
        return self.dot_access_style.value.preamble_stub

    @cached_property
    def format_call_target(self) -> Callable[[str], str]:
        """Callable that formats a call target name."""
        return self.dot_access_style.value.call_target
