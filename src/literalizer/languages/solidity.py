...
@beartype
class Solidity(metaclass=LanguageCls):
    """Solidity language specification."""

    extension = ".sol"
    pygments_name = "solidity"
    ...
    class DateFormats(enum.Enum):
        """Date format options for Solidity."""
    ...
    class DatetimeFormats(enum.Enum):
        """Datetime format options for Solidity."""
    ...
    class SequenceFormats(enum.Enum):
        """Sequence type options for Solidity."""
    ...
    def __init__(  # noqa: PLR0915
        ...
        *,
        ...
        """Initialize Solidity language specification."""
