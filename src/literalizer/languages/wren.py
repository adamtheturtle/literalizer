...
@beartype
def _format_wren_set_entry(_original: Value, item: str) -> str:
    """Format a Wren set entry as a map key with a ``true`` value.
...
@beartype
class Wren(metaclass=LanguageCls):
    """Wren language specification."""
    ...
    def __init__(  # noqa: PLR0915
        ...
        *,
        ...
        """Initialize Wren language specification."""
        ...
        wren_dict_entry = dict_entry_with_template(
            template="{key}: {value}",
