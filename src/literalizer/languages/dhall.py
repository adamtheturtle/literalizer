...
class Dhall(metaclass=LanguageCls):
    ...
    format_string = staticmethod(_format_dhall_string)
    format_integer = staticmethod(_format_dhall_integer)
    format_sequence_entry = staticmethod(passthrough_sequence_entry)
    format_set_entry = staticmethod(passthrough_set_entry)
    format_ordered_map_entry = staticmethod(_format_dhall_dict_entry)
