...
class Gleam(metaclass=LanguageCls):
    ...
    def __init__(  # noqa: PLR0915
        ...
        *,
        ...
        self.format_bytes: Callable[[bytes], str] = _GLEAM_BYTES_FORMATTERS[
            bytes_format.name
        ](constructor_prefix)
        del date_format  # Only ISO format available.
        self.format_date: Callable[[datetime.date], str] = (
            _build_gleam_date_iso(prefix=constructor_prefix)
        )
        del datetime_format  # Only ISO format available.
        self.format_datetime: Callable[[datetime.datetime], str] = (
            _build_gleam_datetime_iso(prefix=constructor_prefix)
        )
        self.format_string: Callable[[str], str] = _build_gleam_str_formatter(
