...
class Perl(metaclass=LanguageCls):
    ...
    class StringFormats(enum.Enum):
        ...
        DOUBLE = _StringEnumMember(value=_format_perl_string_double)
        DOUBLE_UTF8 = _StringEnumMember(value=_format_perl_string_double_utf8)
        SINGLE = _StringEnumMember(value=_format_perl_string_single)
        MULTILINE = _StringEnumMember(value=_format_perl_string_multiline)
