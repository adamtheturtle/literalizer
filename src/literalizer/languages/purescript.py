...
def _reject_negative_zero_call_arg(value: Value, /) -> None:
    ...
    reject_negative_zero(data=value, language_name="PureScript")
...
class PureScript(metaclass=LanguageCls):
    ...
    # A qualified target names a module, which PureScript spells
    # with an initial capital; the declaration grammar above
    # governs what a wrapped file can declare (issue #4525).
    ...
    language_id: ClassVar[str] = "purescript"
