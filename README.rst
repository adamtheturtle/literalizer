...
``literalizer`` converts JSON data structures to native language literal syntax (Python, JavaScript, TypeScript, Go, Ruby, C#, C++, Java, Kotlin, Rust, PHP).
...
.. code-block:: python
   ...
   #                      CSHARP, CPP, JAVA, KOTLIN, RUST, PHP
