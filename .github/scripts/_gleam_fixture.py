"""Shared helper for running a gleam subcommand against a golden file."""
...
def run_gleam_subcommand(subcommand: str) -> None:
    """Copy the primed project, inject the fixture, and run ``gleam
    <subcommand>``.
    """
    ...
    with tempfile.TemporaryDirectory() as tmpdir:
        ...
        if result.returncode != 0:
            msg = (
                f"{filename}: gleam {subcommand} failed\n"
