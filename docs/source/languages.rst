...
Python, Java, C++, C#, Go, JavaScript, TypeScript, Dart, Kotlin, Ruby, Scala, Rust, Lua, Groovy, Crystal, D, and Nim expose a consistently named ``StringFormats.MULTILINE`` option.
