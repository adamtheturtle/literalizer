...
Python, Java, C++, C#, Go, JavaScript, TypeScript, Dart, Kotlin, Ruby, Scala, Rust, Lua, Groovy, and Crystal expose a consistently named ``StringFormats.MULTILINE`` option.
