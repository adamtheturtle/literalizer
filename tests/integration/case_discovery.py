...
VARIANT_ONLY_CASE_DIRS = frozenset(
    {
        ...
        # Rust, Crystal, Nim, V, D, Odin, Zig, and C++ use
        # language-specific value carriers (issues #2910 through #2916
        # and #2919 through #2923, plus #2917). Remaining RECORD
        # languages widen in later sub-issues of #2909, so this case
        # stays out of all-languages base discovery.
