...
VARIANT_ONLY_CASE_DIRS = frozenset(
    {
        ...
        # and Go are the current consumers (issues #2910 and #2911); the
        # remaining RECORD languages widen in later sub-issues of #2909,
        # so it stays out of the all-languages base discovery.
