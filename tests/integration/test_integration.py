...
def _build_variant_cases() -> list[_VariantCase]:
    ...
    variant_sources: list[tuple[Iterable[_Variant], str, str]] = [
        ...
        (_build_type_hint_variants(), "float_list", ""),
        (_build_type_hint_variants(), "int_list", ""),
        (_build_type_hint_variants(), "empty_list", ""),
        (_build_type_hint_variants(), "int_set", ""),
        (_build_type_hint_variants(), "empty_set", ""),
