...
program main
    use fval_m
    implicit none
    call process(fint(1_int64), fint(0_int64), fint(3600_int64))  ! Jan 1 1970 00:00:00 - 01:00:00
    call process(fint(5_int64), fint(0_int64), fint(3600_int64))  ! Jan 1 1970 00:00:05 - 01:00:05
    call process(fint(2_int64), fint(0_int64), fint(5400_int64))  ! Jan 1 1970 00:00:02 - 01:30:02
contains
    subroutine process(ts, start, end)
        implicit none
        type(fval_t), intent(in) :: ts, start, end
