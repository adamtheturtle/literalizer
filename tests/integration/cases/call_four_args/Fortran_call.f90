...
program main
    use fval_m
    implicit none
    call process(fint(1_int64), fint(2_int64), fint(3_int64), fint(4_int64))
    call process(fint(10_int64), fint(20_int64), fint(30_int64), fint(40_int64))
contains
    subroutine process(a, b, c, d)
        implicit none
        type(fval_t), intent(in) :: a, b, c, d
