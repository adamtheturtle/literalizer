...
fn main() {
    let my_data = vec![
        NaiveDateTime::new(NaiveDate::from_ymd_opt(2024, 1, 15).unwrap(), NaiveTime::from_hms_opt(12, 30, 0).unwrap()),
        NaiveDateTime::new(NaiveDate::from_ymd_opt(2024, 6, 30).unwrap(), NaiveTime::from_hms_opt(8, 0, 0).unwrap()),
        NaiveDateTime::new(NaiveDate::from_ymd_opt(2024, 12, 25).unwrap(), NaiveTime::from_hms_opt(18, 45, 0).unwrap()),
    ];
    let _ = my_data;
}
