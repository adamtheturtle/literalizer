...
program main
    ...
    my_data = fmap([fval_t :: &
        fentry('deep', &
    & flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist( &
    & [fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([ &
    & fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([ &
    & fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([ &
    & fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: flist([fval_t :: fint(1_int64) &
    & ])])])])])])])])])])])])])])])])])])])])])])])])])])])])])])) &
    ])
end program main
