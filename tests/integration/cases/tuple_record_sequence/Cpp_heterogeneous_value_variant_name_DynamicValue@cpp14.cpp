...
auto my_data = std::vector<std::map<std::string, DynamicValue>>{
    std::map<std::string, DynamicValue>{{"call", DynamicValue{"send"}}, {"args", DynamicValue{std::vector<DynamicValue>{DynamicValue{1}, DynamicValue{"email"}, DynamicValue{"a@gmail.com"}, DynamicValue{100}}}}},
    std::map<std::string, DynamicValue>{{"call", DynamicValue{"recv"}}, {"args", DynamicValue{std::vector<DynamicValue>{DynamicValue{2}, DynamicValue{"sms"}, DynamicValue{"b@example.com"}, DynamicValue{200}}}}},
};
    (void)my_data;
    return 0;
}
