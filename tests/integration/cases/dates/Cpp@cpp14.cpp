...
auto my_data = std::map<std::string, std::variant<std::chrono::year_month_day, std::chrono::system_clock::time_point>>{
    ...
    {"datetime", std::chrono::system_clock::time_point{std::chrono::sys_days{std::chrono::year_month_day{std::chrono::year{2024}, std::chrono::month{1}, std::chrono::day{15}}} + std::chrono::hours{12} + std::chrono::minutes{30}}},
};
    (void)my_data;
    return 0;
}
