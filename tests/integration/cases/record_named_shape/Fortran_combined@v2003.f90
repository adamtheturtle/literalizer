...
subroutine main_declaration()
    ...
    my_data = flist([fval_t :: &
        fmap([fval_t :: fentry('id', fint(100_int64)), fentry('label', fstr('first entry')), fentry('enabled', &
    & fbool(.false.)), fentry('related_ids', flist([fval_t :: fint(102_int64), fint(103_int64)]))]), &
        fmap([fval_t :: fentry('id', fint(101_int64)), fentry('label', fstr('second entry')), fentry('enabled', &
    & fbool(.true.)), fentry('related_ids', flist([fval_t :: fint(100_int64)]))]) &
    ])
