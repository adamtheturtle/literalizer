...
initial begin
emit(process(_VVal'{tag: _VVAL_STR, i: 0, r: 0.0, s: "hello"}), _VVal'{tag: _VVAL_BOOL, i: 1, r: 0.0, s: ""});
emit(process(_VVal'{tag: _VVAL_INT, i: 42, r: 0.0, s: ""}), _VVal'{tag: _VVAL_BOOL, i: 0, r: 0.0, s: ""});
end
endmodule
