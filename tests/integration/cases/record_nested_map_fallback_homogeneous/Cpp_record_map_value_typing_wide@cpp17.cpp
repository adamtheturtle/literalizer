...
auto my_data = std::vector{
    Record0{"test_1", {"create", "pr_1"}, {{"pr_id", LiteralizerRecordValue{"pr_1"}}, {"status", LiteralizerRecordValue{"draft"}}}},
    Record0{"test_2", {"publish", "pr_1"}, {{"error", LiteralizerRecordValue{"invalid_operation"}}}},
};
    (void)my_data;
    return 0;
}
