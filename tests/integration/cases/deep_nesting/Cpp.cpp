...
#include <variant>
int main() {
const auto my_data = std::map<std::string, std::map<std::string, std::variant<std::map<std::string, std::variant<std::map<std::string, std::map<std::string, std::variant<std::string, std::vector<std::string>>>>, int>>, std::vector<std::map<std::string, std::variant<std::string, std::map<std::string, std::variant<int, std::vector<std::string>>>>>>>>>{
