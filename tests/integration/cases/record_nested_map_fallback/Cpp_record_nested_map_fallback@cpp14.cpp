...
auto my_data = std::vector<Record0>{
    Record0{"test_1", {{"type", Value{"create"}}, {"pr_id", Value{"pr_1"}}, {"draft", Value{true}}, {"missing", Value{nullptr}}}, {{"pr_id", Value{"pr_1"}}, {"status", Value{"draft"}}}},
    Record0{"test_2", {{"type", Value{"publish"}}, {"pr_id", Value{"pr_1"}}}, {{"error", Value{"invalid_operation"}}}},
};
    (void)my_data;
    return 0;
}
