...
#include <variant>
int main() {
const auto my_data = std::map<std::string, std::variant<std::vector<std::variant<int, std::vector<std::nullptr_t>>>, std::vector<std::variant<int, std::vector<std::string>>>>>{
