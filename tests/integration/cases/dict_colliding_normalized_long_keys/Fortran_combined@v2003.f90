...
subroutine main_declaration()
    ...
    type(fval_t) :: my_data
    my_data = fmap([fval_t :: &
        fentry('a_b', fint(1_int64)), &
        fentry('a-b', fint(2_int64)), &
        fentry('averyveryverylongkeynamethatgoesonandonandon', fint(3_int64)), &
        fentry('averyveryverylongkeynamethatgoesonandmore', fint(4_int64)) &
    ])
