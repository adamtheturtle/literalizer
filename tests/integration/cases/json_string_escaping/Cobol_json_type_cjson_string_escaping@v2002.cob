...
01 N0 USAGE POINTER.
01 N1 USAGE POINTER.
01 N1-V PIC X(24) VALUE "a""b" & X"09" & "c" & X"C3" & X"A9" & " #{world} $ident" & X"00".
01 N1-K PIC X(5) VALUE "$key" & X"00".
01 N2 USAGE POINTER.
01 N2-V PIC X(6) VALUE "caf" & X"C3" & X"A9" & X"00".
01 N2-K PIC X(20) VALUE "trailing multi-byte" & X"00".
