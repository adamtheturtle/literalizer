...
CALL_CASE_CONFIGS: list[CallCaseConfig] = [
    ...
    CallCaseConfig(
        ...
        # argument as ``std::tuple`` without needing LiteralizerVariant.
        case_dir_name="call_per_element_false_mixed_list",
        target_function="process",
        parameter_names=["data"],
        call_transform=None,
        transform_stub_names=[],
    ...
    CallCaseConfig(
        ...
        # self-contained, but omitted from ``ref_values``.  The marker
...
CALL_VARIANT_CASE_CONFIGS: list[CallCaseConfig] = [
    CallCaseConfig(
        case_dir_name="call_empty_container_type_hint",
        target_function="process",
