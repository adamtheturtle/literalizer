...
def build_record_nested_map_fallback_variants() -> Iterable[Variant]:
    ...
    ``Dictionary<string, object>`` (issue #2913), and Nim reuses its
    generated object-variant value in ``Table[string, Value]`` (issue
    #2921).  The remaining ``RECORD`` languages gain their own widening
