...
def test_swift_new_variable_leading_digit_is_normalized() -> None:
    """A leading digit must not produce invalid Swift."""
    result = literalize(
        source="1",
        input_format=InputFormat.JSON,
        language=Swift(),
    ...
    assert "let literalizer_1value: Any = 1" in result.code
